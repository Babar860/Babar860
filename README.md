...
- Applied AI for Logistics and Operations

## Featured Research-Oriented Projects
...
- **Directly applicable to:** Agentic AI for Intelligent Decision Support, Trustworthy AI

### HackerRank Orchestrate May 2026 - AI Agent Challenge

Built and submitted an AI agent solution in a competitive global challenge.
...
Full-stack multimodal ML system integrating a Python model backend, .NET APIs, PostgreSQL, and an Android mobile app.
...
**AI / ML:** LLM workflows, RAG, Prompt Engineering, Multi-Agent Systems, Gemini, Vertex AI, LangChain concepts
...
**Tools:** AWS, Docker, Git, CI/CD, Postman

## Currently

- Preparing a research manuscript: *Agentic AI Framework for Intelligent Decision Support Systems Using Retrieval-Augmented Generation* (2026, in preparation)
- Targeting RTP/HDR research programs at Australian universities for the 2027 intake
- Seeking PhD / Research Master's supervision in AI, LLMs, Multi-Agent Systems, and RAG
